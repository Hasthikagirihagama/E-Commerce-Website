        ...
        <div class="table-data">
            <table class="table table-bordered table-hover table-striped text-center">
                ...
                <tbody>
                    <?php
                    //get Shop info
                    $get_shop_query = "SELECT * FROM `shops`";
                    $get_shop_result = mysqli_query($con, $get_shop_query);
                    $id_number = 1;
                    while ($row_fetch_shops = mysqli_fetch_array($get_shop_result)) {
                        $shop_id = $row_fetch_shops['shop_id'];
                        $shop_name = $row_fetch_shops['shop_name'];
                        $shop_description = $row_fetch_shops['shop_description'];
                        $shop_owner = $row_fetch_shops['shop_owner'];
                        echo "
                            <tr>
                            <td>$id_number</td>
                            <td>$shop_name</td>
                            ...
                            <td>$shop_owner</td>
                            <td>
                                <a href='index.php?edit_shop=$shop_id'>
                            ...
                            <td>
                                <a href='index.php?delete_shop=$shop_id' data-bs-toggle='modal' data-bs-target='#deleteModal_$shop_id'>
                                ...
                                <!-- Modal -->
                                <div class='modal fade' id='deleteModal_$shop_id' tabindex='-1' aria-labelledby='deleteModal_$shop_id.Label' aria-hidden='true'>
                                                ...
                                                <div class='d-flex flex-column gap-3 align-items-center text-center'>
                                                    ...
                                                    <div class='btns d-flex gap-3'>
                                                        ...
                                                        <button type='button' class='btn px-5 btn-primary' data-bs-dismiss='modal'>
                                                            <a class='text-light' href='index.php?delete_shop=$shop_id'>
                                                                Delete $shop_name
                                                            </a>
                                                        </button>
                                                    </div>
