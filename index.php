...
include('./includes/connect.php'); // Include database connection first
include('./functions/common_functions.php'); // Then include functions
session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Welcome To the Store | <a>Shop Now</a></span>
    </div>
    <!-- upper-nav -->
    <!-- Start NavBar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">Velvet Vogue</a>
        ...
        <div class="container">
            <div class="row m-0">
                ...
                <div class="col-lg-9 col-md-9 d-none d-sm-none d-md-block pt-md-4">
                    <div class="cover">
                        <span class="title">New Collection Drop</span>
    ...
    <div class="category">
        <div class="container">
            ...
            <div class="cards">
                <div class="card">
                    <span>
                        <i class="fas fa-tshirt" style="font-size: 3em;"></i>
                    </span>
                    <span>T-shirts</span>
                </div>
                <div class="card">
                    <span>
                        <i class="fas fa-male" style="font-size: 3em;"></i>
                    </span>
                    <span>Men's Fashion</span>
                </div>
                <div class="card">
                    <span>
                        <i class="fas fa-female" style="font-size: 3em;"></i>
                    </span>
                    <span>Women's Fashion</span>
                </div>
                <div class="card">
                    <span>
                        <i class="fas fa-child" style="font-size: 3em;"></i>
                    </span>
                    <span>Kids' Clothing</span>
                </div>
                <div class="card">
                    <span>
                        <i class="fas fa-shoe-prints" style="font-size: 3em;"></i>
                    </span>
                    <span>Footwear</span>
                </div>
                <div class="card">
                    <span>
                        <i class="fas fa-hat-cowboy" style="font-size: 3em;"></i>
                    </span>
    ...
    <div class="adver">
        <div class="container">
            <div class="cover">
                <span class="title">Categories</span>
                <span class="desc">Enjoy Your<br />Shopping Experience</span>
